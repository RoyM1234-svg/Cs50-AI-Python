...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        for var, set_domains in self.domains.items():
            for domain in set_domains.copy():
    ...
    def revise(self, x, y):
        ...
        for domain_x in self.domains[x].copy():
            for domain_y in self.domains[y]:
                if domain_x[index_x] == domain_y[index_y]:
                    found = True
            if found:
                continue
            else:
    ...
    def check_overlaps(self,var,assignment):
        for neighbor in self.crossword.neighbors(var):
            if neighbor in assignment.keys():
                (index_x, index_y) = self.crossword.overlaps[var,neighbor]
                if assignment[var][index_x] != assignment[neighbor][index_y]:
                    return False
        return True
    ...
    def consistent(self, assignment):
        ...
        for var, value in assignment.items():
            ...
            if var.length != len(value):
                return False
            if not self.check_overlaps(var,assignment):
                return False
        return True
